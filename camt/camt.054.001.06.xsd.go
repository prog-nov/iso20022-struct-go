...
type AccountNotification12 struct {
	...
	TxsSummry      *TotalTransactions5     `xml:"TxsSummry"`
	Ntry           []*ReportEntry8         `xml:"Ntry"`
...
type BankToCustomerDebitCreditNotificationV06 struct {
	...
	Ntfctn      []*AccountNotification12 `xml:"Ntfctn"`
...
type EntryDetails7 struct {
	...
	TxDtls []*EntryTransaction8 `xml:"TxDtls"`
}
...
type ReportEntry8 struct {
	...
	NtryDtls      []*EntryDetails7                   `xml:"NtryDtls"`
...
type TotalTransactions5 struct {
	...
	TtlNtriesPerBkTxCd []*TotalsPerBankTransactionCode4 `xml:"TtlNtriesPerBkTxCd"`
}
