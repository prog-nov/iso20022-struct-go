...
type CustomerPaymentReversalV08 struct {
	GrpHdr             *GroupHeader75                  `xml:"GrpHdr"`
	OrgnlGrpInf        *OriginalGroupHeader11          `xml:"OrgnlGrpInf"`
	OrgnlPmtInfAndRvsl []*OriginalPaymentInstruction28 `xml:"OrgnlPmtInfAndRvsl"`
...
// OriginalGroupHeader11 ...
type OriginalGroupHeader11 struct {
	OrgnlMsgId   string                    `xml:"OrgnlMsgId"`
	OrgnlMsgNmId string                    `xml:"OrgnlMsgNmId"`
	OrgnlCreDtTm string                    `xml:"OrgnlCreDtTm"`
	RvslRsnInf   []*PaymentReversalReason8 `xml:"RvslRsnInf"`
}

// OriginalPaymentInstruction28 ...
type OriginalPaymentInstruction28 struct {
	...
	RvslRsnInf    []*PaymentReversalReason8 `xml:"RvslRsnInf"`
	TxInf         []*PaymentTransaction93   `xml:"TxInf"`
}
...
// PaymentReversalReason8 ...
type PaymentReversalReason8 struct {
	Orgtr    *PartyIdentification125 `xml:"Orgtr"`
	Rsn      *ReversalReason4Choice  `xml:"Rsn"`
	AddtlInf []string                `xml:"AddtlInf"`
}

// PaymentTransaction93 ...
type PaymentTransaction93 struct {
