...
type CustomerPaymentReversalV06 struct {
	...
	OrgnlPmtInfAndRvsl []*OriginalPaymentInstruction16 `xml:"OrgnlPmtInfAndRvsl"`
...
type OriginalPaymentInstruction16 struct {
	...
	RvslRsnInf    []*PaymentReversalReason7 `xml:"RvslRsnInf"`
	TxInf         []*PaymentTransaction64   `xml:"TxInf"`
}
