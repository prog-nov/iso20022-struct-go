...
type CustomerPaymentStatusReportV08 struct {
	GrpHdr            *GroupHeader52                  `xml:"GrpHdr"`
	OrgnlGrpInfAndSts *OriginalGroupHeader7           `xml:"OrgnlGrpInfAndSts"`
	OrgnlPmtInfAndSts []*OriginalPaymentInstruction23 `xml:"OrgnlPmtInfAndSts"`
...
type OriginalPaymentInstruction23 struct {
	...
	StsRsnInf     []*StatusReasonInformation9       `xml:"StsRsnInf"`
	NbOfTxsPerSts []*NumberOfTransactionsPerStatus5 `xml:"NbOfTxsPerSts"`
	TxInfAndSts   []*PaymentTransaction82           `xml:"TxInfAndSts"`
}
