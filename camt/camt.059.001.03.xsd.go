...
type NotificationToReceiveStatusReportV03 struct {
	...
	OrgnlNtfctnAndSts *OriginalNotification5 `xml:"OrgnlNtfctnAndSts"`
...
type OriginalItemAndStatus3 struct {
	...
	OrgnlItmRef     *OriginalItemReference2            `xml:"OrgnlItmRef"`
}

// OriginalItemReference2 ...
...
type OriginalNotification5 struct {
	...
	AddtlStsInf    string                            `xml:"AddtlStsInf"`
	OrgnlNtfctnRef []*OriginalNotificationReference3 `xml:"OrgnlNtfctnRef"`
}

// OriginalNotificationReference3 ...
type OriginalNotificationReference3 struct {
	...
	DbtrAgt        *BranchAndFinancialInstitutionIdentification5 `xml:"DbtrAgt"`
	IntrmyAgt      *BranchAndFinancialInstitutionIdentification5 `xml:"IntrmyAgt"`
	OrgnlItmAndSts []*OriginalItemAndStatus3                     `xml:"OrgnlItmAndSts"`
}
