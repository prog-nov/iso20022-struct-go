...
type OriginalPaymentInformation4 struct {
	...
	CxlRsnInf     []*CancellationReasonInformation3  `xml:"CxlRsnInf"`
	TxInf         []*PaymentTransactionInformation30 `xml:"TxInf"`
}
...
// PaymentTransactionInformation30 ...
