...
type RequestToModifyPaymentV05 struct {
	Assgnmt        *CaseAssignment4              `xml:"Assgnmt"`
	Case           *Case4                        `xml:"Case"`
	Undrlyg        *UnderlyingTransaction4Choice `xml:"Undrlyg"`
	Mod            *RequestedModification7       `xml:"Mod"`
	InstrForAssgne *InstructionForAssignee1      `xml:"InstrForAssgne"`
	SplmtryData    []*SupplementaryData1         `xml:"SplmtryData"`
}

// RequestedModification7 ...
type RequestedModification7 struct {
	...
	DbtrAcct        *CashAccount24                     `xml:"DbtrAcct"`
	DbtrAgtAcct     *CashAccount24                     `xml:"DbtrAgtAcct"`
	SttlmInf        *SettlementInstruction3            `xml:"SttlmInf"`
	CdtrAgtAcct     *CashAccount24                     `xml:"CdtrAgtAcct"`
...
type UnderlyingTransaction4Choice struct {
	Initn    *UnderlyingPaymentInstruction4 `xml:"Initn"`
	IntrBk   *UnderlyingPaymentTransaction3 `xml:"IntrBk"`
	StmtNtry *UnderlyingStatementEntry2     `xml:"StmtNtry"`
}
