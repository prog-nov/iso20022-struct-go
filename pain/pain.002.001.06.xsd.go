...
type CustomerPaymentStatusReportV06 struct {
	...
	OrgnlPmtInfAndSts []*OriginalPaymentInstruction12 `xml:"OrgnlPmtInfAndSts"`
...
type OriginalPaymentInstruction12 struct {
	...
	StsRsnInf     []*StatusReasonInformation9       `xml:"StsRsnInf"`
	NbOfTxsPerSts []*NumberOfTransactionsPerStatus3 `xml:"NbOfTxsPerSts"`
	TxInfAndSts   []*PaymentTransaction57           `xml:"TxInfAndSts"`
}
