...
type CustomerPaymentReversalV03 struct {
	...
	OrgnlPmtInfAndRvsl []*OriginalPaymentInstruction2 `xml:"OrgnlPmtInfAndRvsl"`
...
type OriginalPaymentInstruction2 struct {
	...
	RvslRsnInf    []*PaymentReversalReason7 `xml:"RvslRsnInf"`
	TxInf         []*PaymentTransaction35   `xml:"TxInf"`
}
