...
type CustomerPaymentCancellationRequestV05 struct {
	...
	Undrlyg     []*UnderlyingTransaction12 `xml:"Undrlyg"`
...
type OriginalPaymentInstruction15 struct {
	...
	CxlRsnInf     []*PaymentCancellationReason2 `xml:"CxlRsnInf"`
	TxInf         []*PaymentTransaction61       `xml:"TxInf"`
}
