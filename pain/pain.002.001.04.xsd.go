...
type CustomerPaymentStatusReportV04 struct {
	...
	OrgnlPmtInfAndSts []*OriginalPaymentInstruction1 `xml:"OrgnlPmtInfAndSts"`
...
type OriginalPaymentInstruction1 struct {
	...
	StsRsnInf     []*StatusReasonInformation9       `xml:"StsRsnInf"`
	NbOfTxsPerSts []*NumberOfTransactionsPerStatus3 `xml:"NbOfTxsPerSts"`
	TxInfAndSts   []*PaymentTransaction32           `xml:"TxInfAndSts"`
}
