...
type ClaimNonReceipt1 struct {
	...
	OrgnlNxtAgt *BranchAndFinancialInstitutionIdentification5 `xml:"OrgnlNxtAgt"`
}

// ClaimNonReceipt1Choice ...
type ClaimNonReceipt1Choice struct {
	Accptd *ClaimNonReceipt1                   `xml:"Accptd"`
...
type CorrectiveTransaction3Choice struct {
	Initn  *CorrectivePaymentInitiation3    `xml:"Initn"`
...
type OriginalGroupHeader9 struct {
	...
	CxlStsRsnInf     []*CancellationStatusReason3      `xml:"CxlStsRsnInf"`
...
type OriginalPaymentInstruction26 struct {
	...
	TxInfAndSts      []*PaymentTransaction84            `xml:"TxInfAndSts"`
}
...
type PaymentTransaction85 struct {
	...
	TxCxlSts            string                             `xml:"TxCxlSts"`
	CxlStsRsnInf        []*CancellationStatusReason3       `xml:"CxlStsRsnInf"`
	RsltnRltdInf        *ResolutionInformation2            `xml:"RsltnRltdInf"`
...
type PaymentTransaction90 struct {
	...
	OrgnlTxId           string                             `xml:"OrgnlTxId"`
	OrgnlClrSysRef      string                             `xml:"OrgnlClrSysRef"`
	ModStsRsnInf        []*ModificationStatusReason1       `xml:"ModStsRsnInf"`
	RsltnRltdInf        *ResolutionInformation2            `xml:"RsltnRltdInf"`
	OrgnlIntrBkSttlmAmt *ActiveOrHistoricCurrencyAndAmount `xml:"OrgnlIntrBkSttlmAmt"`
	OrgnlIntrBkSttlmDt  string                             `xml:"OrgnlIntrBkSttlmDt"`
	Assgnr              *Party35Choice                     `xml:"Assgnr"`
...
type ResolutionInformation2 struct {
	...
	IntrBkSttlmDt  string                             `xml:"IntrBkSttlmDt"`
	ClrChanl       string                             `xml:"ClrChanl"`
	Compstn        *Compensation1                     `xml:"Compstn"`
	Chrgs          []*Charges2                        `xml:"Chrgs"`
}
...
type ResolutionOfInvestigationV08 struct {
	...
	RslvdCase     *Case4                        `xml:"RslvdCase"`
	Sts           *InvestigationStatus4Choice   `xml:"Sts"`
	CxlDtls       []*UnderlyingTransaction19    `xml:"CxlDtls"`
	ModDtls       *PaymentTransaction90         `xml:"ModDtls"`
	ClmNonRctDtls *ClaimNonReceipt1Choice       `xml:"ClmNonRctDtls"`
	StmtDtls      *StatementResolutionEntry3    `xml:"StmtDtls"`
	CrrctnTx      *CorrectiveTransaction3Choice `xml:"CrrctnTx"`
	RsltnRltdInf  *ResolutionInformation2       `xml:"RsltnRltdInf"`
...
type UnderlyingTransaction19 struct {
	OrgnlGrpInfAndSts *OriginalGroupHeader9           `xml:"OrgnlGrpInfAndSts"`
	OrgnlPmtInfAndSts []*OriginalPaymentInstruction26 `xml:"OrgnlPmtInfAndSts"`
	TxInfAndSts       []*PaymentTransaction85         `xml:"TxInfAndSts"`
}
