...
type CustomerPaymentReversalV07 struct {
	GrpHdr             *GroupHeader56                  `xml:"GrpHdr"`
	OrgnlGrpInf        *OriginalGroupHeader3           `xml:"OrgnlGrpInf"`
	OrgnlPmtInfAndRvsl []*OriginalPaymentInstruction21 `xml:"OrgnlPmtInfAndRvsl"`
...
type OriginalPaymentInstruction21 struct {
	...
	RvslRsnInf    []*PaymentReversalReason7 `xml:"RvslRsnInf"`
	TxInf         []*PaymentTransaction77   `xml:"TxInf"`
}
