...
type CustomerPaymentReversalV04 struct {
	...
	OrgnlPmtInfAndRvsl []*OriginalPaymentInstruction7 `xml:"OrgnlPmtInfAndRvsl"`
...
type OriginalPaymentInstruction7 struct {
	...
	RvslRsnInf    []*PaymentReversalReason7 `xml:"RvslRsnInf"`
	TxInf         []*PaymentTransaction42   `xml:"TxInf"`
}
