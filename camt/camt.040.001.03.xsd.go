...
type EstimatedFundCashForecast3 struct {
	...
	EstmtdCshInFcstDtls  []*CashInForecast4                 `xml:"EstmtdCshInFcstDtls"`
	EstmtdCshOutFcstDtls []*CashOutForecast4                `xml:"EstmtdCshOutFcstDtls"`
	EstmtdNetCshFcstDtls []*NetCashForecast2                `xml:"EstmtdNetCshFcstDtls"`
}
...
type FundEstimatedCashForecastReportV03 struct {
	...
	EstmtdFndCshFcstDtls []*EstimatedFundCashForecast3 `xml:"EstmtdFndCshFcstDtls"`
