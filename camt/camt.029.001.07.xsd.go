...
type CorrectiveTransaction2Choice struct {
	Initn  *CorrectivePaymentInitiation2    `xml:"Initn"`
...
type OriginalPaymentInstruction22 struct {
	...
	TxInfAndSts      []*PaymentTransaction78            `xml:"TxInfAndSts"`
}
...
type PaymentTransaction78 struct {
	...
	OrgnlReqdExctnDt  *DateAndDateTimeChoice             `xml:"OrgnlReqdExctnDt"`
	OrgnlReqdColltnDt string                             `xml:"OrgnlReqdColltnDt"`
	OrgnlTxRef        *OriginalTransactionReference24    `xml:"OrgnlTxRef"`
}
...
type ResolutionOfInvestigationV07 struct {
	...
	CxlDtls      []*UnderlyingTransaction17    `xml:"CxlDtls"`
	StmtDtls     *StatementResolutionEntry2    `xml:"StmtDtls"`
	CrrctnTx     *CorrectiveTransaction2Choice `xml:"CrrctnTx"`
	RsltnRltdInf *ResolutionInformation1       `xml:"RsltnRltdInf"`
...
type UnderlyingTransaction17 struct {
	...
	OrgnlPmtInfAndSts []*OriginalPaymentInstruction22 `xml:"OrgnlPmtInfAndSts"`
	TxInfAndSts       []*PaymentTransaction79         `xml:"TxInfAndSts"`
}
