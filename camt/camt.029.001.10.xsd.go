...
type Charges8 struct {
	...
	AgtAcct *CashAccount38                                `xml:"AgtAcct"`
}
...
type OriginalPaymentInstruction35 struct {
	...
	TxInfAndSts      []*PaymentTransaction122           `xml:"TxInfAndSts"`
}
...
type PaymentTransaction116 struct {
	...
	RsltnRltdInf        *ResolutionData2                   `xml:"RsltnRltdInf"`
...
type ResolutionData2 struct {
	...
	IntrBkSttlmDt  string                             `xml:"IntrBkSttlmDt"`
	ClrChanl       string                             `xml:"ClrChanl"`
	Compstn        *Compensation3                     `xml:"Compstn"`
	Chrgs          []*Charges8                        `xml:"Chrgs"`
}
...
type ResolutionOfInvestigationV10 struct {
	...
	CxlDtls       []*UnderlyingTransaction25    `xml:"CxlDtls"`
	ModDtls       *PaymentTransaction116        `xml:"ModDtls"`
...
type UnderlyingTransaction25 struct {
	...
	OrgnlPmtInfAndSts []*OriginalPaymentInstruction35 `xml:"OrgnlPmtInfAndSts"`
	TxInfAndSts       []*PaymentTransaction127        `xml:"TxInfAndSts"`
}
