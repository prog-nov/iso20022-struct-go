...
// NotificationToReceiveStatusReportV05 ...
type NotificationToReceiveStatusReportV05 struct {
	GrpHdr            *GroupHeader60         `xml:"GrpHdr"`
	OrgnlNtfctnAndSts *OriginalNotification9 `xml:"OrgnlNtfctnAndSts"`
...
type OriginalItemAndStatus5 struct {
	...
	OrgnlItmRef     *OriginalItemReference4            `xml:"OrgnlItmRef"`
}

// OriginalItemReference4 ...
...
type OriginalNotification9 struct {
	...
	AddtlStsInf    string                            `xml:"AddtlStsInf"`
	OrgnlNtfctnRef []*OriginalNotificationReference7 `xml:"OrgnlNtfctnRef"`
}

// OriginalNotificationReference7 ...
type OriginalNotificationReference7 struct {
	...
	DbtrAgt        *BranchAndFinancialInstitutionIdentification5 `xml:"DbtrAgt"`
	IntrmyAgt      *BranchAndFinancialInstitutionIdentification5 `xml:"IntrmyAgt"`
	OrgnlItmAndSts []*OriginalItemAndStatus5                     `xml:"OrgnlItmAndSts"`
}
