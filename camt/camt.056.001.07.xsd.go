...
type FIToFIPaymentCancellationRequestV07 struct {
	...
	Undrlyg     []*UnderlyingTransaction20 `xml:"Undrlyg"`
...
type PaymentTransaction89 struct {
	...
	Assgnr              *BranchAndFinancialInstitutionIdentification5 `xml:"Assgnr"`
	Assgne              *BranchAndFinancialInstitutionIdentification5 `xml:"Assgne"`
	CxlRsnInf           []*PaymentCancellationReason4                 `xml:"CxlRsnInf"`
