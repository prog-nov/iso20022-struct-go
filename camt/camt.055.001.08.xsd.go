...
type OriginalPaymentInstruction34 struct {
	...
	CxlRsnInf     []*PaymentCancellationReason5 `xml:"CxlRsnInf"`
	TxInf         []*PaymentTransaction109      `xml:"TxInf"`
}
