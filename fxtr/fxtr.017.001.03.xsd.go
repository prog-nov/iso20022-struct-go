...
// ForeignExchangeTradeStatusAndDetailsNotificationV03 ...
type ForeignExchangeTradeStatusAndDetailsNotificationV03 struct {
	StsDtls             *TradeData9                `xml:"StsDtls"`
	TradInf             *TradeAgreement12          `xml:"TradInf"`
	...
	GnlInf              *GeneralInformation4       `xml:"GnlInf"`
	SpltTradInf         []*SplitTradeDetails1      `xml:"SpltTradInf"`
