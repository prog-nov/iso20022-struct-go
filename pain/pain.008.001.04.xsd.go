...
type CustomerDirectDebitInitiationV04 struct {
	...
	PmtInf      []*PaymentInstruction10 `xml:"PmtInf"`
...
// DirectDebitTransactionInformation13 ...
type DirectDebitTransactionInformation13 struct {
	...
	DrctDbtTx       *DirectDebitTransaction7                      `xml:"DrctDbtTx"`
...
type PaymentInstruction10 struct {
	...
	CdtrSchmeId  *PartyIdentification43                        `xml:"CdtrSchmeId"`
	DrctDbtTxInf []*DirectDebitTransactionInformation13        `xml:"DrctDbtTxInf"`
}
