...
// CreditTransferTransaction56 is Additional information that cannot be captured in the structured elements and/or any other specific block.
...
// FinancialInstitutionCreditTransferV10 is Additional information that cannot be captured in the structured elements and/or any other specific block.
type FinancialInstitutionCreditTransferV10 struct {
	GrpHdr      *GroupHeader96                 `xml:"GrpHdr"`
	CdtTrfTxInf []*CreditTransferTransaction56 `xml:"CdtTrfTxInf"`
	SplmtryData []*SupplementaryData1          `xml:"SplmtryData"`
}
...
// RemittanceInformation2 is Information supplied to enable the matching of an entry with the items that the transfer is intended to settle, for example, commercial invoices in an accounts' receivable system in an unstructured form.
