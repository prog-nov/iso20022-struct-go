...
type CustomerPaymentCancellationRequestV10 struct {
	Assgnmt     *CaseAssignment5           `xml:"Assgnmt"`
	Case        *Case5                     `xml:"Case"`
	CtrlData    *ControlData1              `xml:"CtrlData"`
	Undrlyg     []*UnderlyingTransaction30 `xml:"Undrlyg"`
...
// OriginalPaymentInstruction44 ...
type OriginalPaymentInstruction44 struct {
	...
	CxlRsnInf     []*PaymentCancellationReason5 `xml:"CxlRsnInf"`
	TxInf         []*PaymentTransaction140      `xml:"TxInf"`
}
...
// PaymentTransaction140 ...
type PaymentTransaction140 struct {
...
// UnderlyingTransaction30 ...
type UnderlyingTransaction30 struct {
	OrgnlGrpInfAndCxl *OriginalGroupHeader15          `xml:"OrgnlGrpInfAndCxl"`
	OrgnlPmtInfAndCxl []*OriginalPaymentInstruction44 `xml:"OrgnlPmtInfAndCxl"`
}
