...
type CustomerPaymentReversalV09 struct {
	GrpHdr             *GroupHeader88                  `xml:"GrpHdr"`
	OrgnlGrpInf        *OriginalGroupHeader16          `xml:"OrgnlGrpInf"`
	OrgnlPmtInfAndRvsl []*OriginalPaymentInstruction33 `xml:"OrgnlPmtInfAndRvsl"`
...
type OriginalPaymentInstruction33 struct {
	...
	RvslRsnInf    []*PaymentReversalReason9 `xml:"RvslRsnInf"`
	TxInf         []*PaymentTransaction108  `xml:"TxInf"`
}
...
type PaymentTransaction108 struct {
