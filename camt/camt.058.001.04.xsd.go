...
type NotificationToReceiveCancellationAdviceV04 struct {
	...
	OrgnlNtfctn *OriginalNotification8 `xml:"OrgnlNtfctn"`
...
type OriginalNotification8 struct {
	...
	OrgnlNtfctnRef []*OriginalNotificationReference6 `xml:"OrgnlNtfctnRef"`
}

// OriginalNotificationReference6 ...
type OriginalNotificationReference6 struct {
	...
	DbtrAgt    *BranchAndFinancialInstitutionIdentification5 `xml:"DbtrAgt"`
	IntrmyAgt  *BranchAndFinancialInstitutionIdentification5 `xml:"IntrmyAgt"`
	OrgnlItm   []*OriginalItem4                              `xml:"OrgnlItm"`
}
