...
type AccountNotification5 struct {
	Id             string                  `xml:"Id"`
	NtfctnPgntn    *Pagination             `xml:"NtfctnPgntn"`
	...
	Intrst         []*AccountInterest2     `xml:"Intrst"`
	TxsSummry      *TotalTransactions2     `xml:"TxsSummry"`
	Ntry           []*ReportEntry3         `xml:"Ntry"`
...
type BankToCustomerDebitCreditNotificationV03 struct {
	...
	Ntfctn      []*AccountNotification5 `xml:"Ntfctn"`
...
type EntryDetails2 struct {
	...
	TxDtls []*EntryTransaction3 `xml:"TxDtls"`
}
...
type EntryTransaction3 struct {
	...
	CardTx      *CardTransaction1                  `xml:"CardTx"`
...
type ReportEntry3 struct {
	...
	Intrst        []*TransactionInterest3            `xml:"Intrst"`
	CardTx        *CardEntry1                        `xml:"CardTx"`
	NtryDtls      []*EntryDetails2                   `xml:"NtryDtls"`
...
type TotalTransactions2 struct {
	TtlNtries          *NumberAndSumOfTransactions2     `xml:"TtlNtries"`
	TtlCdtNtries       *NumberAndSumOfTransactions1     `xml:"TtlCdtNtries"`
	TtlDbtNtries       *NumberAndSumOfTransactions1     `xml:"TtlDbtNtries"`
	TtlNtriesPerBkTxCd []*TotalsPerBankTransactionCode2 `xml:"TtlNtriesPerBkTxCd"`
}
