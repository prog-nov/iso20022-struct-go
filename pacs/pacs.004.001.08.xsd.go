...
// PaymentReturnReason4 ...
type PaymentReturnReason4 struct {
...
// PaymentReturnV08 ...
type PaymentReturnV08 struct {
	GrpHdr      *GroupHeader72          `xml:"GrpHdr"`
	OrgnlGrpInf *OriginalGroupHeader12  `xml:"OrgnlGrpInf"`
	TxInf       []*PaymentTransaction87 `xml:"TxInf"`
	SplmtryData []*SupplementaryData1   `xml:"SplmtryData"`
}

// PaymentTransaction87 ...
type PaymentTransaction87 struct {
	...
	InstgAgt            *BranchAndFinancialInstitutionIdentification5 `xml:"InstgAgt"`
	InstdAgt            *BranchAndFinancialInstitutionIdentification5 `xml:"InstdAgt"`
	RtrChain            *TransactionParties5                          `xml:"RtrChain"`
	RtrRsnInf           []*PaymentReturnReason4                       `xml:"RtrRsnInf"`
...
// TransactionParties5 ...
type TransactionParties5 struct {
	UltmtDbtr     *Party35Choice                                `xml:"UltmtDbtr"`
	Dbtr          *Party35Choice                                `xml:"Dbtr"`
