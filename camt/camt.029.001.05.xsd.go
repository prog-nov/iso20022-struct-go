...
type OriginalPaymentInstruction10 struct {
	...
	TxInfAndSts      []*PaymentTransaction54            `xml:"TxInfAndSts"`
}
...
type ResolutionOfInvestigationV05 struct {
	...
	CxlDtls      []*UnderlyingTransaction9     `xml:"CxlDtls"`
...
// UnderlyingTransaction9 ...
type UnderlyingTransaction9 struct {
	OrgnlGrpInfAndSts *OriginalGroupHeader5           `xml:"OrgnlGrpInfAndSts"`
	OrgnlPmtInfAndSts []*OriginalPaymentInstruction10 `xml:"OrgnlPmtInfAndSts"`
	TxInfAndSts       []*PaymentTransaction53         `xml:"TxInfAndSts"`
}
