...
type ExternalUnableToApplyIncorrectData1Code string

// ExternalUnableToApplyMissingData1Code ...
type ExternalUnableToApplyMissingData1Code string
...
type IncorrectData1Choice struct {
	Cd    string `xml:"Cd"`
	Prtry string `xml:"Prtry"`
}
...
// MissingData1Choice ...
type MissingData1Choice struct {
	Cd    string `xml:"Cd"`
	Prtry string `xml:"Prtry"`
}

// MissingOrIncorrectData1 ...
type MissingOrIncorrectData1 struct {
	AMLReq     bool                       `xml:"AMLReq"`
	MssngInf   []*UnableToApplyMissing2   `xml:"MssngInf"`
	IncrrctInf []*UnableToApplyIncorrect2 `xml:"IncrrctInf"`
}
...
type UnableToApplyIncorrect2 struct {
	Tp              *IncorrectData1Choice `xml:"Tp"`
	AddtlIncrrctInf string                `xml:"AddtlIncrrctInf"`
}

// UnableToApplyJustification4Choice ...
type UnableToApplyJustification4Choice struct {
	AnyInf            bool                     `xml:"AnyInf"`
	MssngOrIncrrctInf *MissingOrIncorrectData1 `xml:"MssngOrIncrrctInf"`
	PssblDplctInstr   bool                     `xml:"PssblDplctInstr"`
}

// UnableToApplyMissing2 ...
type UnableToApplyMissing2 struct {
	Tp            *MissingData1Choice `xml:"Tp"`
	AddtlMssngInf string              `xml:"AddtlMssngInf"`
}

// UnableToApplyV09 ...
type UnableToApplyV09 struct {
	Assgnmt     *CaseAssignment5                   `xml:"Assgnmt"`
	Case        *Case5                             `xml:"Case"`
	Undrlyg     *UnderlyingTransaction7Choice      `xml:"Undrlyg"`
	Justfn      *UnableToApplyJustification4Choice `xml:"Justfn"`
...
type UnderlyingTransaction7Choice struct {
	Initn    *UnderlyingPaymentInstruction7 `xml:"Initn"`
	IntrBk   *UnderlyingPaymentTransaction6 `xml:"IntrBk"`
