...
// NotificationToReceiveCancellationAdviceV05 ...
type NotificationToReceiveCancellationAdviceV05 struct {
	GrpHdr      *GroupHeader59          `xml:"GrpHdr"`
	OrgnlNtfctn *OriginalNotification10 `xml:"OrgnlNtfctn"`
...
type OriginalNotification10 struct {
	...
	NtfctnCxl      bool                              `xml:"NtfctnCxl"`
	OrgnlNtfctnRef []*OriginalNotificationReference8 `xml:"OrgnlNtfctnRef"`
}

// OriginalNotificationReference8 ...
type OriginalNotificationReference8 struct {
	...
	DbtrAgt    *BranchAndFinancialInstitutionIdentification5 `xml:"DbtrAgt"`
	IntrmyAgt  *BranchAndFinancialInstitutionIdentification5 `xml:"IntrmyAgt"`
	OrgnlItm   []*OriginalItem5                              `xml:"OrgnlItm"`
}
