...
type CustomerPaymentReversalV10 struct {
	...
	OrgnlPmtInfAndRvsl []*OriginalPaymentInstruction37 `xml:"OrgnlPmtInfAndRvsl"`
...
type OriginalGroupHeader16 struct {
	...
	RvslRsnInf   []*PaymentReversalReason9 `xml:"RvslRsnInf"`
}
...
type OriginalPaymentInstruction37 struct {
	...
	RvslRsnInf    []*PaymentReversalReason9 `xml:"RvslRsnInf"`
	TxInf         []*PaymentTransaction125  `xml:"TxInf"`
}
