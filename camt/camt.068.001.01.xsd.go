...
type AdditionalParameters16 struct {
	PrtlSttlm         string `xml:"PrtlSttlm"`
	PrvsPrtlConfId    string `xml:"PrvsPrtlConfId"`
...
type IntraBalanceMovementConfirmationV01 struct {
	Id          *DocumentIdentification51                     `xml:"Id"`
	AddtlParams *AdditionalParameters16                       `xml:"AddtlParams"`
	...
	IntraBal    *IntraBalance6                                `xml:"IntraBal"`
