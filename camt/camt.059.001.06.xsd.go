...
type GroupHeader84 struct {
	...
	MsgRcpt *Party40Choice `xml:"MsgRcpt"`
}
...
type OriginalItemAndStatus6 struct {
	...
	OrgnlItmRef     *OriginalItemReference5            `xml:"OrgnlItmRef"`
}

// OriginalItemReference5 ...
...
type OriginalNotification11 struct {
	...
	AddtlStsInf    string                            `xml:"AddtlStsInf"`
	OrgnlNtfctnRef []*OriginalNotificationReference9 `xml:"OrgnlNtfctnRef"`
}

// OriginalNotificationReference9 ...
