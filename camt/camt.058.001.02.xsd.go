...
type NotificationToReceiveCancellationAdviceV02 struct {
	...
	OrgnlNtfctn *OriginalNotification4 `xml:"OrgnlNtfctn"`
}
...
type OriginalNotification4 struct {
	...
	OrgnlNtfctnRef []*OriginalNotificationReference1 `xml:"OrgnlNtfctnRef"`
}

// OriginalNotificationReference1 ...
type OriginalNotificationReference1 struct {
	...
	DbtrAgt    *BranchAndFinancialInstitutionIdentification5 `xml:"DbtrAgt"`
	IntrmyAgt  *BranchAndFinancialInstitutionIdentification5 `xml:"IntrmyAgt"`
	OrgnlItm   []*OriginalItem2                              `xml:"OrgnlItm"`
}
