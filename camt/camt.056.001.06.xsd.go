...
type FIToFIPaymentCancellationRequestV06 struct {
	...
	Undrlyg     []*UnderlyingTransaction16 `xml:"Undrlyg"`
...
type OriginalGroupHeader6 struct {
	...
	CxlRsnInf    []*PaymentCancellationReason3 `xml:"CxlRsnInf"`
}
...
// UnderlyingTransaction16 ...
type UnderlyingTransaction16 struct {
	OrgnlGrpInfAndCxl *OriginalGroupHeader6   `xml:"OrgnlGrpInfAndCxl"`
	TxInf             []*PaymentTransaction75 `xml:"TxInf"`
}
