...
type AccountReport12 struct {
	Id           string                  `xml:"Id"`
	RptPgntn     *Pagination             `xml:"RptPgntn"`
	...
	TxsSummry    *TotalTransactions3     `xml:"TxsSummry"`
...
type TotalTransactions3 struct {
	TtlNtries          *NumberAndSumOfTransactions3     `xml:"TtlNtries"`
